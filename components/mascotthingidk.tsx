...
import penguin from "../assets/logos/penguin.svg";
import bomb from "../assets/logos/bomb.svg";
import boom from "../assets/logos/boom.svg";
...
const DraggableSquare: React.FC = () => {
  ...
  const handleSearchAndTranslate = async () => {
    ...
    if (targetElement) {
      setMessage("Found!! FIRE IN THE HOLE");
  ...
  return (
    <>
      ...
      >
        <Image
          id="bomb"
          src={showBomb ? bomb.src : boom.src}
