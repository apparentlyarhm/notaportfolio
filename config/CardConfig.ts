...
export const cardConfig: CardConfig[] = [
  {
    ...
    footerText: "1K HOURS",
    gamedesc:
      "This is where my humble beginnings resides in gaming in general. In 8th Standard I used to have frequent LAN parties w/ friends that eventually led us to buy the game the following year. I genuinely believe that its the best shooter/fps ever made, but the recent transition to cs2 is not it man. First it just runs worse and then the playerbase is pretty much dead because some missing iconic features. I'm sad about this and wish the golden days return fr",
  },
  {
    heading: "Valorant",
    footerText: "1K HOURS",
  ...
  },
  {
    ...
    gamedesc:
      "Again, as the numbers say, no need for introductions. This game is popular as hell and for a good reason; the environment, gameplay, graphics still holds up today. The story is well written, dialogues are good, and feel very engaging. The online counterpart, GTA Online is equally as good, perfect to goof around with friends and do heists which are so well thought out that it really feels like a movie. I was able to grab the game for free (thanks Epic) but even if its in the neighbourhood of 500-1K Rs, I would consider it bang for the buck.",
  },
  {
    heading: "Half Life 2",
    footerText: "idk how long",
    gamedesc:
